	...
	<div id="wpac-platform-container">
		...
		<header>
			...
			<div class="platform-left">
				...
				<span class="platform-title">Kims Group</span>
			</div>
		...
		<div class="platform-layout">
			...
			<main id="app-body">
				...
				if ( $current_app === 'dashboard' ) {
					echo '<h2>Welcome to Kims Group Platform</h2><p style="margin-top:100px;padding:50px 20px;border:1px solid #ccc;">Please select app from sidebar to begin.</p>';
				}
